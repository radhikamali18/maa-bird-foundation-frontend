  ...
  return ( 
    <footer className="bg-green-950 text-white"> 
      <div className="mx-auto max-w-7xl px-5 py-12 lg:px-8"> 
        ...
        <div className="grid gap-10 md:grid-cols-3 md:gap-16 lg:gap-20"> 
          ...
          <div> 
            ...
            <p className="max-w-md text-lg leading-6 text-green-100"> 
          ...
          <div> 
            ...
            <div className="flex flex-col gap-2 text-lg text-green-100"> 
          ...
          <div> 
            ...
            <div className="space-y-3 text-lg text-green-100"> 
        ...
        {/* Bottom */} 
        <div className="mt-10 border-t border-green-800 pt-6 text-center text-lg text-green-200"> 
          <p> 
